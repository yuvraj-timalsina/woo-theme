<?php
/**
 * The template for displaying posts in archive page
 *
...
<article <?php post_class(); ?>>
	...
	<div class="meta">
		<p><?php esc_html_e('Author', 'uv-woo') ?> : <?php the_author_posts_link(); ?> | <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_the_date() ); ?></a>
			<br>
			<?php if ( has_category() ) : ?>
